...
[`check-changelog.sh`](../check-changelog.sh), copied beside the workflow from this skill, is the check — one step, rather than an inline grep beside it that would be a second, weaker copy of the same rule:
